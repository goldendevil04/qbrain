        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="text-center mb-20">
              <div className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-cyan-400/10 to-green-400/10 border border-cyan-400/30 rounded-full backdrop-blur-sm mb-8 hover:scale-105 transition-all duration-300">
                <Users className="h-5 w-5 text-cyan-400 mr-3" />
                <span className="text-base font-bold text-cyan-400">Meet Our Team</span>
              </div>
              
              <div className="relative inline-block mb-8">
                <h2 className="text-6xl md:text-7xl lg:text-8xl font-bold bg-gradient-to-r from-cyan-400 to-green-400 bg-clip-text text-transparent">
                  About Qbrain
                </h2>
              ...
              <p className="text-2xl md:text-3xl text-gray-400 leading-relaxed max-w-5xl mx-auto">
            ...
            <div className="mb-24">
              <div className="text-center mb-16">
                <div className="flex items-center justify-center gap-3 mb-6">
                  ...
                  <h3 className="text-4xl md:text-5xl font-bold text-white">Our Mission</h3>
            ...
            <div className="mb-24">
              <div className="text-center mb-16">
                <div className="flex items-center justify-center gap-3 mb-6">
                  ...
                  <h3 className="text-4xl md:text-5xl font-bold text-white">Recent Achievements</h3>
                  <Trophy className="h-8 w-8 text-yellow-400" />
                </div>
                <p className="text-xl text-gray-400 max-w-4xl mx-auto leading-relaxed">
              ...
              <div className="relative group h-full">
                ...
                <div className="relative bg-slate-800/70 border-2 border-green-400/30 rounded-3xl p-12 backdrop-blur-md hover:border-green-400/60 transition-all duration-500 h-full flex flex-col">
                  ...
                  <div className="flex items-center mb-8">
                    ...
                    <h3 className="text-3xl font-bold text-white ml-4">Team Leader</h3>
                  </div>
                  ...
                  <div className="flex flex-col items-center text-center mb-8">
                    ...
                    <div className="mb-6">
                      ...
                      <div className="inline-block px-4 py-2 bg-gradient-to-r from-green-400 to-cyan-400 rounded-full mb-3">
                        <p className="text-black font-bold text-lg">Founding Member & Team Lead</p>
                      </div>
              ...
              <div className="relative group max-w-6xl mx-auto">
                ...
                <div className="relative bg-slate-800/70 border-2 border-cyan-400/30 rounded-3xl p-12 backdrop-blur-md hover:border-cyan-400/60 transition-all duration-500">
                  ...
                  <div className="flex items-center justify-center mb-8">
                    ...
                    <h3 className="text-4xl font-bold text-white ml-4">Our Vision</h3>
                  </div>
