  ...
  const socialLinks = [
    {
      name: 'LinkedIn',
      icon: Linkedin,
      url: 'https://linkedin.com/company/qbrain-tech',
      color: 'text-blue-400 hover:text-blue-300'
    },
    {
      name: 'GitHub',
      icon: Github,
      url: 'https://github.com/qbrain-team',
      color: 'text-gray-300 hover:text-white'
    },
    {
      name: 'Instagram',
      icon: Instagram,
      url: 'https://instagram.com/qbrain.tech',
  ...
  const contactInfo = [
    {
      icon: MapPin,
      title: 'Location',
      details: ['BWU Campus', 'Brahmanand Nagar, Narela', 'Delhi, India'],
      color: 'text-cyan-400'
    },
    {
      icon: Clock,
    ...
    },
    {
      icon: Phone,
      title: 'Contact',
      details: ['+91 98765 43210', 'team@qbrain.tech'],
            ...
            <div className="lg:col-span-1 space-y-8">
              ...
              <div className="relative group">
                ...
                <div className="relative bg-slate-800/50 border border-green-400/30 rounded-2xl p-6 backdrop-blur-sm text-center">
                  ...
                  <a
                    href="https://wa.me/+919876543210?text=Hi! I'm interested in learning more about Qbrain team."
                    target="_blank"
